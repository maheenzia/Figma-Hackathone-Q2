...
export default function Topcategories() {
  ...
  return (
    <div className=" mx-auto max-w-screen-2xl py-20">
      <div>
        <h1 className="text-3xl font-bold mb-4 pl-4">Top Categories</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10">
          {Data.map((val: Category, i: number) => (
            <div
              key={i}
              className="group h-96 bg-cover bg-center flex flex-col items-center rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
              style={{
