...
export default function BuyingProduct() {
  return (
    <div className="bg-lightgray-100 container mx-auto p-4 md:p-8 lg:px-24 lg:py-40">
      <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-10">
        {/* Products Section */}
        <div className="w-full md:w-3/5">
          <h1 className="text-5xl md:text-xl font-bold mb-6">Chairs</h1>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-4 text-gray-800">
                    <AiOutlineHeart className="text-2xl cursor-pointer hover:text-easternblue-600 hover:scale-105 transition-all" />
                    <FiTrash className="text-2xl cursor-pointer hover:text-gray-500 hover:scale-105 transition-all" />
                  </div>
                </div>
              </div>
        ...
        <div className="w-full md:w-1/3 flex flex-col justify-center items-center gap-6 bg-white shadow rounded-lg p-6">
          ...
          <button className="w-full text-lg md:text-base font-semibold text-white bg-easternblue-600 rounded-full py-3 mt-6 hover:bg-easternblue-700 transition">
            Member Checkout
          </button>
        </div>
      </div>
